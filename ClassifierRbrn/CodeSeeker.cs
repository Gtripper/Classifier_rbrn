...
namespace Classifier
{
    ...
    public class CodeSeeker : ICodeSeeker
    {
        ...
        {
            var pattern = @"участ\w*\s*размещен\w*\s*административ\w*[-\s]*делов\w*\s*объектов:|участ\w*\s*размещен\w*\s*жилищ\w*[-\s]*коммунал\w*\s*объектов:|участ\w*\s*размещен\w*\s*торгов\w*[-\s]*бытов\w*\s*объектов:|участ\w*\s*размещен\w*\s*спортив\w*[-\s]*рекреацион\w*\s*объектов:|участ\w*\s*размещен\w*\s*многоквартир\w*\s*жил\w*\s*домов:|участ\w*\s*размещен\w*\s*учеб\w*[-\s]*воc\w*\s*объектов:";
