...
namespace Classifier.Tests
{
    ...
    class IFactoryTests
    {
        ...
        [TestCase("Объекты размещения помещений и технических устройств общественных туалетов (1.2.9)", 4, "",
            false, false, false, "12.0.2", 400, 4000)]
        #endregion
        #region Type 500
        ...
        [TestCase("Многоквартирный дом с подземной автопарковкой", "2.5, 2.6")]
        ...
        #endregion
        #region Type 500
        [TestCase(@"Для строительства подъездной дороги и разворотной площадки", "7.2.1, 12.0.1")]
        [TestCase(@"Для строительства подъездной автодороги и разворотной площадки", "7.2.1, 12.0.1")]
        [TestCase(@"Для строительства подъездной автомобильной дороги и разворотной площадки", "7.2.1, 12.0.1")]
        ...
        [TestCase(@"Для размещения и эксплуатации объектов автомобильного транспорта и объектов дорожного хозяйства", "7.2, 7.2.1")]
        ...
        [TestCase("ПОД ЭКСПЛУАТАЦИЮ БАЗЫ ДЛЯ ХРАНЕНИЯ МАШИН И МЕХАНИЗМОВ, СКЛАДИРОВАНИЯ МАТЕРИАЛОВ, ТОВАРОВ НАРОДНОГО ПОТРЕБЛЕНИЯ И ПРОДУКТОВ ПИТАНИЯ", "4.4, 6.9")]
